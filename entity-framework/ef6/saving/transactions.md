...
Das neue Connection Resiliency-Feature funktioniert nicht mit vom Benutzer initiierte Transaktionen. Weitere Informationen finden Sie unter [Limitations with Retrying Execution Strategies](~/ef6/fundamentals/connection-resiliency/retry-logic.md#limitations).  
