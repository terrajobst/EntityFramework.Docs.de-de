...
Neben der Produktdokumentation erwähnt kann diese Blogs eine Quelle für nützliche Informationen zu Entity Framework sein:

## <a name="ef-team-blogs"></a>EF-Team-blogs

- [.NET Blog - Tag: Entitätsframework](https://blogs.msdn.microsoft.com/dotnet/tag/entity-framework/)
- [ADO.NET Blog (nicht mehr in Verwendung)](https://blogs.msdn.microsoft.com/adonet/)
- [EF Entwurfsblog (nicht mehr in Verwendung)](https://blogs.msdn.microsoft.com/efdesign/)
