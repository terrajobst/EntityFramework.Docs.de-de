...
* [Konfigurieren Sie das Modell](xref:core/modeling/index), um Aspekte wie [required](xref:core/modeling/required-optional) (erforderlich) und [maximum length](xref:core/modeling/max-length) (maximale Länge) anzugeben.
