...
Das Oracle .NET-Team hat angekündigt, dass sie voraussichtlich ungefähr im dritten Quartal von 2018 einen Erstanbieter für EF Core veröffentlichen werden. Weitere Informationen finden Sie in der [Absichtserklärung für .NET Core und Entity Framework Core](http://www.oracle.com/technetwork/topics/dotnet/tech-info/odpnet-dotnet-ef-core-sod-4395108.pdf).
...
In der Zwischenzeit hat das EF-Team einen [EF Core-Beispielanbieter für Oracle-Datenbanken](https://github.com/aspnet/EntityFrameworkCore/tree/master/samples/OracleProvider) erzeugt.
Der Zweck des Projekts besteht nicht darin, einen EF Core-Anbieter zu erstellen, der im Besitz von Microsoft ist.
Wir haben das Projekt begonnen, um Lücken in den relationalen und grundlegenden Funktionen von EF Core zu identifizieren, die wir beheben mussten, um eine bessere Unterstützung für Oracle bereitzustellen.
Es sollte auch Oracle oder Dritten dabei helfen, die Entwicklung von Oracle-Anbietern für EF Core zu beschleunigen.

Wir werden Beiträge berücksichtigen, die die Beispielimplementierung verbessern.
Auch würden wir es begrüßen und unterstützen, wenn eine Communityinitiative zum Erstellen eines Open Source-basierten Oracle-Anbieters für EF Core mit dem Beispiel als Ausgangspunkt zustande käme.
