...
Uns ist bewusst, dass viele bestehende Anwendungen frühere Versionen von EF verwenden und dass die Portierung auf EF Core nur zur Nutzung von .NET Core unter Umständen mit einem erheblichen Aufwand verbunden ist. Aus diesem Grund haben wir die neueste Version von EF 6 portiert, sodass sie unter .NET Core 3.0 ausgeführt werden kann. 
